...
export function DataTableToolbar<TData>({ table, filterColumn, filterTitle, filterOptions, seachInputPlaceholder, customFacetMap }: DataTableToolbarProps<TData>) {
        ...
        <div className="flex items-center justify-between pb-4">
            <div className="flex flex-1 items-center justify-between space-x-2">
                ...
                <div className="flex items-center space-x-2">
                    {table.getColumn(filterColumn) && <DataTableFacetedFilter column={table.getColumn(filterColumn)} title={filterTitle} options={filterOptions} customFacetMap={customFacetMap} />}
